...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("shHit") or v.Name == ("Swordsh") or v.Name == ("LuffyshTail") or v. == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "Luffy Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Luffy Hub"})
